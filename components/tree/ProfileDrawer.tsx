...
export default function ProfileDrawer({ member, onClose }: ProfileDrawerProps) {
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              >
                ...
                <div className="space-y-2">
                  {parents.length > 0 && (
                    <RelationshipGroup label="Parents" members={parents} />
                  )}
                  {spouse && (
                    <RelationshipGroup label="Spouse" members={[spouse]} />
                  )}
                  {children.length > 0 && (
                    <RelationshipGroup label="Children" members={children} />
                  )}
                </div>
              </motion.div>
...
function RelationshipGroup({ label, members }: { label: string; members: FamilyMember[] }) {
